...
<script src="https://cdn.datatables.net/plug-ins/1.10.19/features/mark.js/datatables.mark.js"></script>
...
<body>
    ...
    <script type="text/javascript">
        ...
        function sentimentChart() {
            ...
            var div = d3.select("#sentiment").append("div")
                .attr("class", "tooltip")
                .style("opacity", 0);
            ...
            d3.json("query_all.php", function(error, data) {
                ...
                svg.selectAll(".dot")
                    ...
                    .attr("class", "dot_neutral") // Assign a class for styling
                    .attr("cx", function(d, i) { return x(d.date) })
                    .attr("cy", function(d) { return y(d.neutral) })
                    .attr("r", 3)
                    .on("mouseover", function (d) {
                        div.transition()
                            .duration(100)
                            .style("opacity", .9);
                        div.html(d.date.toDateString() + "<br> Value:" + d.neutral)
                ...
                svg.selectAll(".dot")
                    .data(data)
                    .enter().append("circle") // Uses the enter().append() method
                    .attr("class", "dot_positive") // Assign a class for styling
                    .attr("cx", function(d, i) { return x(d.date) })
                    ...
                    .on("mouseover", function (d) {
                        div.transition()
                            .duration(100)
                            .style("opacity", .9);
                        div.html(d.date.toDateString() + "<br> Value:" + d.positive)
                            .style("left", (d3.event.pageX) + "px")
                            .style("top", (d3.event.pageY - 28) + "px");
                    })
                    .on("mouseout", function(d) {
                ...
                svg.selectAll(".dot")
                    .data(data)
                    .enter().append("circle") // Uses the enter().append() method
                    .attr("class", "dot_negative") // Assign a class for styling
                    .attr("cx", function(d, i) { return x(d.date) })
                    .attr("cy", function(d) { return y(d.negative) })
                    .attr("r", 3)
                    .on("mouseover", function (d) {
                        div.transition()
                            .duration(100)
                            .style("opacity", .9);
                        div.html(d.date.toDateString() + "<br> Value:" + d.negative)
                            .style("left", (d3.event.pageX) + "px")
                            .style("top", (d3.event.pageY - 28) + "px");
                    })
                    .on("mouseout", function(d) {
        ...
        function mediaChart(){
            ...
            var div = d3.select("#media").append("div")
                .attr("class", "tooltip")
                .style("opacity", 0);
            ...
            d3.json("query_media.php", function(error, data) {
                ...
                svg.selectAll(".dot")
                    .data(data)
                    .enter().append("circle") // Uses the enter().append() method
                    .attr("class", "dot_news") // Assign a class for styling
                    .attr("cx", function(d, i) { return x(d.date) })
                    ...
                    .on("mouseover", function (d) {
                        div.transition()
                            .duration(100)
                            .style("opacity", .9);
                        div.html(d.date.toDateString() + "<br/>News:" + d.news)
                            .style("left", (d3.event.pageX) + "px")
                            .style("top", (d3.event.pageY - 28) + "px");
                    })
                    .on("mouseout", function(d) {
                ...
                svg.selectAll(".dot")
                    .data(data)
                    .enter().append("circle") // Uses the enter().append() method
                    .attr("class", "dot_blog") // Assign a class for styling
                    .attr("cx", function(d, i) { return x(d.date) })
                    .attr("cy", function(d) { return y(d.blog) })
                    .attr("r", 3)
                    .on("mouseover", function (d) {
                        div.transition()
                            .duration(100)
                            .style("opacity", .9);
                        div.html(d.date.toDateString() + "<br> Blogs:" + d.blog)
                            .style("left", (d3.event.pageX) + "px")
                            .style("top", (d3.event.pageY - 28) + "px");
                    })
                    .on("mouseout", function(d) {
        ...
        function table() {
            ...
            var table = $('#dataTable').DataTable( {
                ...
                },
                {
                    ...
                    "createdCell": function (td, cellData, rowData, row, col) {
                        if ( cellData > 0.15 ) {
                            $(td).css('background-image', 'url(greenDot.png)');
                            $(td).css('background-repeat', 'no-repeat');
                            $(td).css('background-position', 'center');
                            $(td).css('font-size', '0');
        
                        } else if (  cellData < -0.15 )
                        {
                            $(td).css('background-image', 'url(redDot.png)');
                            $(td).css('background-repeat', 'no-repeat');
                            $(td).css('background-position', 'center');
                            $(td).css('font-size', '0');
                        } else {
                            $(td).css('background-image', 'url(greyDot.png)');
                            $(td).css('background-repeat', 'no-repeat');
                            $(td).css('background-position', 'center');
                            $(td).css('font-size', '0');
                        }
                ...
                //     if ( aData["media"] == "Blog" )
                //     {
                //         $('td', nRow).css('background-color', '#FDE6A4');
                //     }
                //     else if ( aData["media"] == "News" )
                //     {
                //         $('td', nRow).css('background-color', '#97A1FE');
                //     }
                // }
